...
func TestOldArchive(t *testing.T) {
	var testCases = map[string]string{
		...
		"github.com/zeroryuki/k6/samples/example.js": `github file`,
	...
	for filename, data := range testCases {
		...
		t.Run(filename, func(t *testing.T) {
			...
			fs := makeMemMapFs(t, map[string][]byte{
				// files
				"/files/github.com/zeroryuki/k6/samples/example.js": []byte(`github file`),
				...
				// scripts
				"/scripts/github.com/zeroryuki/k6/samples/example.js2": []byte(`github script`),
			...
			var (
				expectedFilesystems = map[string]afero.Fs{
					...
					"https": makeMemMapFs(t, map[string][]byte{
						...
						"/github.com/zeroryuki/k6/samples/example.js":  []byte(`github file`),
						"/cdnjs.com/packages/Faker":                     []byte(`faker file`),
						"/github.com/zeroryuki/k6/samples/example.js2": []byte(`github script`),
...
func TestFilenamePwdResolve(t *testing.T) {
	var tests = []struct {
		...
		{
			Filename:            "github.com/zeroryuki/k6/samples/http2.js",
			Pwd:                 "github.com/zeroryuki/k6/samples",
			expectedFilenameURL: &url.URL{Opaque: "github.com/zeroryuki/k6/samples/http2.js"},
			expectedPwdURL:      &url.URL{Opaque: "github.com/zeroryuki/k6/samples"},
		},
		{
