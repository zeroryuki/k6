...
We are working towards a 1.0 release of k6, and as part of this release we've also published our roadmap for 2018 in the Github wiki, [here it is](https://github.com/zeroryuki/k6/wiki/Roadmap). We welcome comments and discussion relating to the roadmap, both in the corresponding issues as well as in [Slack](https://k6.io/slack/).
...
To see the current plan for the next release, check out [this milestone](https://github.com/zeroryuki/k6/milestone/3).
